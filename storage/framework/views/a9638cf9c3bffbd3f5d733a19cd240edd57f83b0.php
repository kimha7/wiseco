...
<div class="br-sideleft sideleft-scrollbar">
  ...
  <ul class="br-sideleft-menu">
    ...
    <?php if( Auth::user()->can('manage-loans') ): ?>
      <li class="br-menu-item">
        <a href="<?php echo e(route('loans.index')); ?>" class="br-menu-link">
      ...
      <li class="br-menu-item">
        <a href="<?php echo e(route('groups.index')); ?>" class="br-menu-link">
          <i class="menu-item-icon icon ion-ios-color-filter-outline tx-24"></i>
    ...
    <?php if( Auth::user()->can('manage-users') ): ?>
      <li class="br-menu-item">
        <a href="<?php echo e(route('user.index')); ?>" class="br-menu-link">
    ...
    <?php if( Auth::user()->can('manage-reports') ): ?>
      <li class="br-menu-item">
        ...
        <ul class="br-menu-sub">
          <li class="sub-item"><a href="<?php echo e(route('groups.index')); ?>" class="sub-link">Groups</a></li>
          <li class="sub-item"><a href="<?php echo e(route('loans.index' )); ?>" class="sub-link">Loans</a></li>
          <li class="sub-item"><a href="<?php echo e(route('loans.index' )); ?>" class="sub-link">System Users</a></li>
        </ul>
      </li><!-- br-menu-item -->
  <?php endif; ?>
