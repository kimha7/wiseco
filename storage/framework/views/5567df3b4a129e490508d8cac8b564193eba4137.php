...
<div class="br-mainpanel">
  ...
  <div class="br-pagebody">
    <div>
      ...
      <?php endif; ?>
      <form method="POST" action="<?php echo e(route('payables.store')); ?>">
          <?php echo csrf_field(); ?>
      ...
      <table id="datatable1" class="table display responsive nowrap">
        ...
        <tbody>
          <?php $__currentLoopData = $payables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payable): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($payable->id); ?></td>
              <td><?php echo e($payable->fullname); ?></td>
              <td><?php echo e($payable->amount); ?></td>
              <td><?php echo e($payable->user->fullName); ?></td>
              <td><?php echo e($payable->notes); ?></td>
              <td><?php echo e($payable->status); ?></td>
              <td><?php echo e($payable->created_at); ?></td>
              <td><?php if( $payable->status == 'Pending'): ?>
